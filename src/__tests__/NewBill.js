...
describe("Given I am connected as an employee", () => {
  describe("When I am on NewBill Page", () => {
    beforeEach(() => {
      ...
      localStorage.setItem("user", JSON.stringify({ type: "Employee", email: "employee@example.com" }));
      router();
    ...
    test("When the form is submitted, handleSubmit should be called", () => {
      ...
      const handleSubmitSpy = jest.spyOn(newBill, "handleSubmit").mockImplementation((e) => e.preventDefault());
